...
def evaluate(model, val_dataloader, criterion):
    ...
    with torch.no_grad():
        for (
            ...
            val_outputs = model(
                val_field, val_candidate, val_words, val_positions, masks
            )
    ...
    return val_accuracy, val_loss, recall, precision
...
if __name__ == "__main__":
    ...
    print(
        f"Test Accuracy: {test_accuracy} Test Loss: {test_loss} Test Recall: {test_recall}"
    )
