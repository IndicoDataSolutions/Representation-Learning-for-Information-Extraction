...
def get_tesseract_results(image_path):
    ...
    ocr_result = pytesseract.image_to_data(
        image, config="--oem 1 --psm 3", output_type=Output.DICT
    )
    return ocr_result


# TODO: filter out ocr results that don't have a corresponding xml.
if __name__ == "__main__":

    dataset_dir = "./assets/images/mantis/labeled"
    images_dir = "./assets/images/mantis"
