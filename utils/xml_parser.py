...
def get_data(xml_path, split_name="train"):
    ...
    for annot in tqdm(annotation_files, desc="Reading Annotations"):
        try:
            ...
            blank_dict = {"true_candidates": [], "other_candidates": []}
            field_list = [
                "Document Title",
                "Document Number",
                "Return to Address",
            ...
            annotation_data = {
                ...
                "fields": {f: deepcopy(blank_dict) for f in field_list},
            }
            ...
            for element_obj in element_objs:
                ...
                if class_name not in annotation_data["fields"]:
                    print(
                        "Unidentified field Found:", class_name, "in file:", annot.name
                    )
                    continue
                else:
                ...
                annotation_data["fields"][class_name]["true_candidates"].append(
                    {"x1": x1, "x2": x2, "y1": y1, "y2": y2, "difficult": difficulty}
                )
